...
<div className="anim-rise mt-10">
  ...
  <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
    ...
    <p className="mt-3 text-slate-500">
      Add your first guest review using the form above.
    </p>
...
<div className="mt-10 rounded-3xl border border-indigo-100 bg-gradient-to-br from-white to-indigo-50 p-8 shadow-lg">
  ...
  className="ml-3 rounded-xl border border-slate-300 px-6 py-3 hover:bg-slate-100"
>
Clear
</button>
